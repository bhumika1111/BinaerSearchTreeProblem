...
namespace BinarySearchTree
{
    ...
    internal class CreateBinaryFighure<T> where T : IComparable<T>
    {
        public T NodeData { get; set; }
        //For left sub Tree
        public CreateBinaryFighure<T> LeftTree { get; set; }
        //For Right sub Tree
        public CreateBinaryFighure<T> RightTree { get; set; }

        public CreateBinaryFighure(T nodeData)
        {
            NodeData = nodeData;
            LeftTree = null;
            RightTree = null;
        ...
        public void Insert(T item)
        {
            ...
            if (currentNodeValue.CompareTo(item) > 0)
            {
                ...
                if (LeftTree == null)
                {
                    ...
                    LeftTree = new CreateBinaryFighure<T>(item);
            ...
            else
            {
                ...
                if (RightTree == null)
                {
                    ...
                    RightTree = new CreateBinaryFighure<T>(item);
                }
