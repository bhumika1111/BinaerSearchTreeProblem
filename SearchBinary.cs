...
namespace BinarySearchTree
{
    ...
    internal class SearchBinary<T> where T : IComparable<T>
    {
        public T NodeData { get; set; }
        //For left sub Tree
        public SearchBinary<T> LeftTree { get; set; }
        //For Right sub Tree
        public SearchBinary<T> RightTree { get; set; }

        public SearchBinary(T nodeData)
        {
            NodeData = nodeData;
            LeftTree = null;
            RightTree = null;
        ...
        public void Insert(T item)
        {
            ...
            if (currentNodeValue.CompareTo(item) > 0)
            {
                ...
                if (LeftTree == null)
                {
                    ...
                    LeftTree = new SearchBinary<T>(item);
            ...
            else
            {
                ...
                if (RightTree == null)
                {
                    ...
                    RightTree = new SearchBinary<T>(item);
                }
        ...
        //creation method for search in BST.
        public void SearchTree(T Element, SearchBinary<T> BinaryTree)
        {
            if(BinaryTree == null)
            {
            ...
            {
                Console.WriteLine("{0} is Present in Binary Search Tree",BinaryTree.NodeData);
            }
